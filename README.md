# SEi31 ([General Assembly, Sydney](https://generalassemb.ly/sydney))
### Homework Repository
...
- **Clone your forked repository to your computer**
    ...
    + Make sure your browser is open to **your** forked version of this repository on Github (eg [http://github.com/{{YOUR_USERNAME}}/sei31-homework](http://github.com/{{YOUR_USERNAME}}/sei31-homework)).
...
- **Add an upstream remote repository**
    ...
    + `cd homework`
    + `git remote add upstream https://github.com/Yiannimoustakas/sei31-homework.git`
...
- **Once you're finished, submit a pull request for me to accept your homework**
    + Navigate to your forked version of this repository on Github (eg [https://github.com/{{YOUR_USERNAME_HERE}}/sei31-homework](https://github.com/{{YOUR_USERNAME_HERE}}/sei31-homework)).
